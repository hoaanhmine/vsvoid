function onCreate()
  --background
  makeLuaSprite('spaceBG','space/spaceBG',-450, -220)
  setScrollFactor('spaceBG', 0.2, 0.2);
  scaleObject('spaceBG',1.65,1.65)
  addLuaSprite('spaceBG',false)
  
  makeAnimatedLuaSprite('holoBop','space/holoEmpty-V',-400,-375)
  ...
  makeLuaSprite('spacerocks','space/spacerocks',-350, -100)
